...
class Game:
    def __init__(self):
        ...
        pygame.display.set_icon(pygame.image.load('assets/icon/sword.png'))
        ...
        self.player = Player(self, 'player', self.player_pos, (self.assets['player'].get_width(),self.assets['player'].get_height())) 
        # self.player_movement_y = [False, False]
        # self.player_movement_x = [False, False]
    ...
    def run(self):
        while self.game_run:
            ...
            # self.screen.blit(pygame.transform.scale(self.display, (DISPLAY_WIDTH, DISPLAY_HEIGHT)), (0,0))
